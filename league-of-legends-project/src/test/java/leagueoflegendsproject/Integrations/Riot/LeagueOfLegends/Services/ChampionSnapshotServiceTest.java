...
public class ChampionSnapshotServiceTest {
    private IntegrationChampionService championService;
    ...
    public void setup() {
        ...
        championService = new IntegrationChampionService(httpClientMock);
    }
