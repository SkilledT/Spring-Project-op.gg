...
public class BottomPerformanceStrategy implements PerformanceStrategy {
    ...
    public Double countPerformanceRate(MatchParticipant matchParticipant) {
        MatchParticipantAveragePerformance matchParticipantAveragePerformance = matchParticipantAveragePerformanceRepository
                .findByTierAndIndividualPosition(matchParticipant.getSummoner().getTier(), getIndividualPosition())
                .orElse(null);
        ...
        var csKilledPerMinuteZScore = NumericalHelpers.Standardization
                .getZValue(matchParticipant.getTotalMinionsKilled(), matchParticipantAveragePerformance.getAvgTotalMinionsKilled().doubleValue(), matchParticipantAveragePerformance.getStdevOfTotalMinionsKilled().doubleValue());
        var damageDealtZScore = NumericalHelpers.Standardization
                .getZValue(matchParticipant.getTotalDamageDealtToChampions(), matchParticipantAveragePerformance.getAvgDealtDamageToChampions().doubleValue(), matchParticipantAveragePerformance.getStdevOfDealtDamageToChampions().doubleValue());
        var pentakillZScore = NumericalHelpers.Standardization
                .getZValue(matchParticipant.getPentakills(), matchParticipantAveragePerformance.getAvgPentakill().doubleValue(), matchParticipantAveragePerformance.getAvgPentakill().doubleValue());
